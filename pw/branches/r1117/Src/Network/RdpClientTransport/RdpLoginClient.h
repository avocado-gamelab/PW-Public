...
public:
  LoginClient( ni_udp::IRdp * _rdp, const ni_udp::NetAddr & _loginSvcAddr, unsigned _loginSvcMux, const nstl::string & _login, const nstl::string & _password, const nstl::string & _sessionKey, const nstl::string & _serverAddress );
  ...
  void ChangeServerAddress( const nstl::string & _newServerAddress, const ni_udp::NetAddr & _newAddr ) { serverAddress = _newServerAddress; loginSvcAddr = _newAddr; }
