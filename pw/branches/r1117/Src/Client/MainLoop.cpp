...
void CreateSystemScreens()
{
  ...
  // Sanity-ping для overlay: игрок видит что render работает с самого старта.
  NMainLoop::NetworkStatusOverlay::Instance().Log( "Client started, waiting for login..." );
}
...
bool Step( bool bAppActive, vector<Input::Event>& inputEvents )
{
  ...
  //@iA@FIXME: ��������! DrawScreens ���������� ��������� UI � _�������_ ��������� �� ��������� �� ���������� ������ UIRenderer-�
  ...
  if ( !Render::GetRenderer()->DeviceIsLost() )
  {
    ...
    // Overlay поверх всего — даже когда login-screen non-transparent перекрывает Console.
    NMainLoop::NetworkStatusOverlay::Instance().Draw();
